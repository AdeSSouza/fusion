    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado', models.DateField(auto_now=True, verbose_name='Atualizacão')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-cog', 'Engranagem'), ('lni-stats-up', 'Gráfico'), ('lni-users', 'Usuários'), ('lni-layers', 'Design'), ('lni-mobile', 'Mobile'), ('lni-rocket', 'Foguete')], max_length=12, verbose_name='Ícone')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagem', stdimage.models.StdImageField(force_min_size=False, upload_to='equipe', variations={'thumb': {'crop': True, 'height': 480, 'width': 480}}, verbose_name='Imafem')),
